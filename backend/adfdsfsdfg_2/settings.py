"""
Django settings for adfdsfsdfg_2 project.
...
ROOT_URLCONF = 'adfdsfsdfg_2.urls'
...
WSGI_APPLICATION = 'adfdsfsdfg_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "adfdsfsdfg Support <support@adfdsfsdfg-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "adfdsfsdfg_2 API",
    "DESCRIPTION": "API documentation for adfdsfsdfg_2 App",
    "VERSION": "v1",
}
